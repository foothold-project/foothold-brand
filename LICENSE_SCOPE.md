...
| Scope | License |
|---|---|
| `scripts/**`, `figma/plugin/**`, `tokens/generate_tokens.py` | MIT |
| `tokens/foothold.tokens.json`, generated token CSS, schemas | MIT |
...
| `assets/osmu/**` approved medium-specific compositions containing a FOOTHOLD mark | Reserved brand assets; see `BRAND_USAGE_POLICY.md` |
| `assets/raster/**` PNG/JPG derivatives containing a FOOTHOLD mark | Reserved brand assets; same policy as their canonical SVG source |
